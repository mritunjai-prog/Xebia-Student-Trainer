...
export const TakeCoding = () => {
  ...
  if (!currentUser || !assessment) {
    return (
      <div className="p-8 text-center bg-white dark:bg-neutral-900 rounded-2xl border border-brand-border dark:border-neutral-700 dark:border-neutral-800">
        ...
        <button onClick={() => navigate('/')} className="mt-4 px-4 py-2 bg-[#6C1D5F] hover:bg-[#84117C] text-neutral-900 dark:text-white rounded-2xl text-xs font-bold font-display uppercase tracking-wider">
          Return to Dashboard
        </button>
      </div>);
  }
  ...
  return (
    <div
      ...
      className="h-screen flex flex-col bg-brand-bg-light dark:bg-[#1E1E1E] text-neutral-800 dark:text-neutral-200 overflow-hidden font-sans select-none">
      ...
      <header className="h-14 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between px-4 shrink-0">
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-1.5 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-all cursor-pointer">
            
            <ChevronLeft className="w-5 h-5" />
          </button>
          
          <div className="h-4 w-px bg-neutral-100 dark:bg-neutral-800"></div>
          ...
          {problems.map((prob, idx) => {
            ...
            return (
              <button
                ...
                className={`w-7 h-7 rounded-lg text-xs font-bold font-mono border flex items-center justify-center transition-all cursor-pointer ${idx === currentProblemIdx ? 'bg-[#6C1D5F] border-[#6C1D5F] text-neutral-900 dark:text-white' : hasSub ? 'bg-emerald-950/40 border-emerald-800 text-emerald-400' : 'bg-neutral-100 dark:bg-neutral-800 border-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}
                title={prob.question}>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 px-3 py-1 bg-neutral-100 dark:bg-neutral-800 rounded-lg text-rose-400 font-mono font-bold text-xs border border-rose-900/40">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="p-1.5 bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-lg cursor-pointer"
            ...
            <button
              ...
              className="px-4 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-neutral-900 dark:text-white font-display font-bold rounded-2xl text-xs uppercase tracking-wider shadow-lg shadow-emerald-950/20 cursor-pointer flex items-center gap-1">
      ...
      {/* 2. Workspace Layout */}
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex flex-col lg:border-r border-b lg:border-b-0 border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 overflow-hidden shrink-0 lg:shrink">
          ...
          <div className="h-10 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between px-3 shrink-0">
            <div className="flex gap-1">
              <button
                ...
                className={`px-3 py-1 text-xs font-bold rounded-lg cursor-pointer transition-all ${sidebarTab === 'problem' ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}>
                
                Problem Description
              </button>
              <button
                onClick={() => setSidebarTab('hints')}
                className={`px-3 py-1 text-xs font-bold rounded-lg cursor-pointer transition-all ${sidebarTab === 'hints' ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}>
                
                Hints ({currentProblem.codingHints?.length || 0})
              </button>
              <button
                onClick={() => setSidebarTab('history')}
                className={`px-3 py-1 text-xs font-bold rounded-lg cursor-pointer transition-all ${sidebarTab === 'history' ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}>
          ...
          <div className="flex-1 overflow-y-auto p-5 md:p-6 space-y-6">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <span key={t} className="px-2 py-0.5 bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400 rounded-full text-[9px] font-mono flex items-center gap-1">
                ...
                <div className="prose prose-sm prose-invert max-w-none text-neutral-700 dark:text-neutral-300 text-xs md:text-sm leading-relaxed space-y-4">
                  <div className="bg-neutral-50 dark:bg-neutral-950/40 border border-neutral-200 dark:border-neutral-800 p-4 rounded-2xl space-y-2">
              ...
              <div className="space-y-2">
                    ...
                    <pre className="bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 p-3 rounded-2xl font-mono text-xs text-neutral-500 dark:text-neutral-400 overflow-x-auto whitespace-pre-wrap leading-relaxed">
                      {currentProblem.codingConstraints}
                    </pre>
                  </div>
              }
              ...
              <div className="space-y-1.5">
                    ...
                    <p className="text-xs text-neutral-700 dark:text-neutral-300 leading-relaxed bg-neutral-50 dark:bg-neutral-950/40 p-3 rounded-2xl border border-neutral-200 dark:border-neutral-800">
                      {currentProblem.codingInputFormat}
                    </p>
                  </div>
              }
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <pre className="bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 p-3 rounded-2xl font-mono text-xs text-emerald-400 overflow-x-auto leading-normal">
              ...
              <div className="p-3.5 bg-neutral-50 dark:bg-neutral-950/30 border border-neutral-200 dark:border-neutral-800 rounded-2xl flex gap-2.5 text-neutral-500 dark:text-neutral-400">
                    <Info className="w-5 h-5 text-blue-500 shrink-0" />
                    <div className="text-[11px] leading-relaxed">
                      <strong className="text-neutral-700 dark:text-neutral-300 font-medium">Author Notes:</strong> {currentProblem.codingNotes}
                    </div>
                  </div>
              }
              </div>
            ...
            <div className="space-y-4">
              ...
              <div key={i} className="p-4 bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-2xl space-y-1.5">
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400">No hints available for this problem.</p>
              }
              </div>
            }
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400">No attempts saved yet. Click "Submit Code" to runhidden tests.</p> :

              previousAttempts.map((att, idx) =>
              <div key={att.id} className="p-3.5 bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-2xl flex items-center justify-between gap-3 text-xs">
                      <div>
                        <div className="flex items-center gap-1.5">
                        ...
                        <p className="text-[10px] text-neutral-500 dark:text-neutral-400 mt-0.5">{new Date(att.submittedAt).toLocaleTimeString()}</p>
                      </div>
        ...
        {/* Right Panel: Code Editor */}
          <div className="w-full lg:w-1/2 flex flex-col bg-brand-bg-light dark:bg-[#1E1E1E] overflow-hidden flex-1">
          
          {/* Editor Header Settings Panel */}
          <div className="h-10 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between px-3 shrink-0">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-750 text-neutral-900 dark:text-white font-mono font-bold text-xs px-2.5 py-1 rounded-lg border border-neutral-700 outline-none cursor-pointer">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-1">
                <span className="text-[9px] uppercase font-bold text-neutral-500 dark:text-neutral-400">Theme:</span>
                <button
                  onClick={() => setEditorTheme((prev) => prev === 'vs-dark' ? 'light' : 'vs-dark')}
                  className="px-2 py-0.5 bg-neutral-100 dark:bg-neutral-800 border border-neutral-700 hover:bg-neutral-700 rounded text-[10px] text-neutral-700 dark:text-neutral-300 font-mono uppercase tracking-wide cursor-pointer">
              ...
              {/* Font controls */}
              <div className="flex items-center gap-1">
                <span className="text-[9px] uppercase font-bold text-neutral-500 dark:text-neutral-400">Font:</span>
                <button
                  onClick={() => setFontSize((prev) => Math.max(12, prev - 1))}
                  className="w-5 h-5 bg-neutral-100 dark:bg-neutral-800 border border-neutral-700 hover:bg-neutral-700 rounded text-xs font-mono text-neutral-700 dark:text-neutral-300 flex items-center justify-center cursor-pointer">
          ...
          <div className="flex-1 relative overflow-hidden bg-brand-bg-light dark:bg-[#1E1E1E]">
            <Editor
              height="100%"
          ...
          <div className="h-64 bg-white dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800 flex flex-col overflow-hidden shrink-0">
            {/* Terminal Header Tab Selectors */}
            <div className="h-9 bg-neutral-50 dark:bg-neutral-950 border-b border-neutral-850 flex items-center justify-between px-3 shrink-0">
              <div className="flex gap-1.5">
                <button
                  onClick={() => setConsoleTab('testcases')}
                  className={`px-3 py-1 text-[11px] font-bold rounded-lg cursor-pointer flex items-center gap-1.5 ${consoleTab === 'testcases' ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}>
                  
                  <Terminal className="w-3.5 h-3.5" /> Test Cases
                </button>
                <button
                  onClick={() => setConsoleTab('console')}
                  className={`px-3 py-1 text-[11px] font-bold rounded-lg cursor-pointer flex items-center gap-1.5 ${consoleTab === 'console' ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}>
                ...
                <button
                  ...
                  className={`px-3 py-1 text-[11px] font-bold rounded-lg cursor-pointer flex items-center gap-1.5 ${consoleTab === 'results' ? 'bg-emerald-950 text-emerald-400' : 'text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}>
              ...
              <button
                ...
                className="text-[10px] font-bold text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-300 flex items-center gap-1 cursor-pointer transition-all">
            ...
            <div className="flex-1 overflow-y-auto p-4 bg-neutral-50 dark:bg-neutral-950 font-mono text-xs">
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    className="rounded border-neutral-700 text-[#01AC9F] bg-neutral-100 dark:bg-neutral-800 accent-[#01AC9F]" />
                ...
                <div className="space-y-2">
                    ...
                    className="w-full h-24 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg p-2.5 font-mono text-xs text-neutral-900 dark:text-white outline-none focus:border-neutral-700" />
                ...
                <div className="space-y-3">
                    ...
                    map((tc, i) =>
                    <div key={tc.id} className="p-3 bg-white dark:bg-neutral-900/60 border border-neutral-850 rounded-lg space-y-1">
                              <span className="text-[10px] font-bold text-neutral-500 dark:text-neutral-400 uppercase">Sample Case #{i + 1}</span>
                              <div className="grid grid-cols-2 gap-2 text-[11px]">
                                <div>
                                  <span className="text-neutral-500 dark:text-neutral-400">Input:</span> <span className="text-neutral-700 dark:text-neutral-300 font-mono">{tc.input.replace('\n', ' ')}</span>
                                </div>
                                <div>
                                  <span className="text-neutral-500 dark:text-neutral-400">Expected:</span> <span className="text-emerald-500 font-mono">{tc.expectedOutput}</span>
                                </div>
                              </div>
                            </div>
                    )}
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="p-2 bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-850">
                      <span className="text-[10px] text-neutral-500 dark:text-neutral-400 uppercase">Execution Time</span>
                      <h5 className="text-xs font-bold text-neutral-900 dark:text-white mt-0.5 font-mono">{evaluationResult.executionTime}s</h5>
                    </div>
                    <div className="p-2 bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-850">
                      <span className="text-[10px] text-neutral-500 dark:text-neutral-400 uppercase">Memory usage</span>
                      <h5 className="text-xs font-bold text-neutral-900 dark:text-white mt-0.5 font-mono">{evaluationResult.memoryUsage} MB</h5>
                    </div>
                    <div className="p-2 bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-850">
                      <span className="text-[10px] text-neutral-500 dark:text-neutral-400 uppercase">Core Status</span>
                  ...
                  <div key={idx} className={`p-3 rounded-2xl border flex items-center justify-between text-[11px] ${tr.passed ? 'bg-green-950/25 border-green-900 text-green-300' : 'bg-rose-950/25 border-rose-900 text-rose-300'}`}>
                          <div className="space-y-0.5">
                            <span className="text-[9px] uppercase font-bold text-neutral-500 dark:text-neutral-400">Case #{idx + 1} ({tr.visibility})</span>
                            <div className="flex gap-2 font-mono">
                              <span>Input: <strong className="text-neutral-900 dark:text-white">{tr.input.replace('\n', ' ')}</strong></span>
                              <span>Expected: <strong className="text-neutral-900 dark:text-white">{tr.expected}</strong></span>
                              <span>Got: <strong className="text-neutral-900 dark:text-white">{tr.actual}</strong></span>
                            </div>
                          </div>
                  ...
                  <p className="text-[10px] text-neutral-500 dark:text-neutral-400 text-center py-4">Custom input evaluated successfully. Review the logs in Console.</p>
                  }
                  </div>
                </div>
              }
            ...
            <div className="h-12 bg-neutral-50 dark:bg-neutral-950 border-t border-neutral-850 flex items-center justify-between px-3 shrink-0">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-1.5 bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white border border-neutral-700 text-xs font-black uppercase rounded-lg tracking-wider transition-all cursor-pointer flex items-center gap-1.5 disabled:opacity-50">
                ...
                <button
                  ...
                  disabled={isEvaluating}
                  className="px-5 py-1.5 bg-[#6C1D5F] hover:bg-[#84117C] text-neutral-900 dark:text-white text-xs font-black uppercase rounded-lg tracking-wider transition-all cursor-pointer flex items-center gap-1.5 disabled:opacity-50 shadow-md shadow-purple-950/25">
      ...
      <AnimatePresence>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            ...
            className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-3xl p-6 max-w-md w-full shadow-2xl text-neutral-800 dark:text-neutral-200 space-y-4">
              ...
              <div className="flex items-center gap-3 border-b border-neutral-200 dark:border-neutral-800 pb-3">
                ...
                <div>
                  <h4 className="font-display font-black text-sm text-neutral-900 dark:text-white uppercase tracking-wider">Finalize Exam Submission?</h4>
                  <p className="text-[10px] text-neutral-500 dark:text-neutral-400">Lock in your current scores and exit the sandbox</p>
                </div>
              </div>
              ...
              <div className="space-y-2.5 text-xs">
                ...
                <div className="p-3.5 bg-neutral-50 dark:bg-neutral-950/60 border border-neutral-850 rounded-2xl space-y-2 font-mono text-[10px]">
                  <span className="text-neutral-500 dark:text-neutral-400 font-bold uppercase block">Current status breakdown:</span>
                  {problems.map((prob, i) => {
                  const match = codingSubmissions.find((sub) => sub.problemId === prob.id && sub.studentId === currentUser.id);
                  return (
                    <div key={prob.id} className="flex justify-between items-center text-neutral-700 dark:text-neutral-300">
                        <span>Q{i + 1}: {prob.question}</span>
                        <span className={`font-bold ${match ? 'text-green-400' : 'text-neutral-500 dark:text-neutral-400'}`}>
              ...
              <div className="flex items-center justify-end gap-2 border-t border-neutral-200 dark:border-neutral-800 pt-3">
                <button
                onClick={() => setShowConfirmModal(false)}
                className="px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-2xl text-xs font-bold font-display uppercase tracking-wider text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white cursor-pointer">
                
                  Cancel
                </button>
                <button
                onClick={handleFinalizeExam}
                className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-neutral-900 dark:text-white font-display font-bold rounded-2xl text-xs uppercase tracking-wider shadow-lg shadow-emerald-950/20 cursor-pointer">
