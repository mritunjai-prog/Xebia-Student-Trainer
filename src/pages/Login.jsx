...
export const Login = () => {
  ...
  const handleLoginSubmit = (e) => {
    ...
    if (success) {
      ...
      navigate(role === 'teacher' ? '/trainer-dashboard' : '/student-dashboard');
    } else {
  ...
  const handleQuickLogin = (quickEmail, quickRole) => {
    ...
    if (success) {
      ...
      navigate(quickRole === 'teacher' ? '/trainer-dashboard' : '/student-dashboard');
    }
  };
                    ...
                    {demoTeachers.map((t, idx) => (
                      ...
                      >
                        ...
                        <div className="truncate flex-1">
                          <p className="font-extrabold text-neutral-800 dark:text-neutral-200 truncate group-hover:text-[#6C1D5F] dark:group-hover:text-purple-400 transition-colors">{t.name.split(' ')[1]}</p>
                  ...
                  <div className="space-y-2">
                    ...
                    {demoStudents.map((s, idx) => (
                      ...
                      >
                        ...
                        <div className="truncate flex-1">
                          <p className="font-extrabold text-neutral-800 dark:text-neutral-200 truncate group-hover:text-[#01AC9F] dark:group-hover:text-emerald-400 transition-colors">{s.name.split(' ')[0]}</p>
