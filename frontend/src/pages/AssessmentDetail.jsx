...
export const AssessmentDetail = () => {
  ...
  const cachedAssessment = useMemo(() => assessments.find((a) => a.id === id), [assessments, id]);
  ...
  useEffect(() => {
    ...
    assessmentApi.get(id)
      ...
      .catch((error) => {
        if (active) setDetailError(error.message || 'Failed to load assessment details.');
      })
      .finally(() => {
  ...
  if (detailLoading && !assessment) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
        ...
        <h2 className="text-2xl font-bold text-neutral-700 dark:text-neutral-300">Loading Assessment...</h2>
      </div>
    );
  }

  if (detailError && !assessment) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
        <AlertCircle className="w-16 h-16 text-neutral-400" />
        <h2 className="text-2xl font-bold text-neutral-700 dark:text-neutral-300">Could Not Load Assessment</h2>
  ...
  const statusColor = {
    ...
    closed: 'bg-neutral-100 text-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 border-neutral-200 dark:border-neutral-700'
  }[assessment.status] || 'bg-neutral-100 text-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 border-neutral-200 dark:border-neutral-700';
  ...
  }[assessment.difficulty] || 'text-neutral-600 dark:text-neutral-400 bg-neutral-50 dark:bg-neutral-950/20 border-neutral-100 dark:border-neutral-900/50';
